      ...
      <div class="conteudo_painel">
        <div class="conteudo_painel_int">
          ...
          <div class="well well-sm">
            ...
            <form class="flat" action="nalterar.php" method="post">
              <p><label for="cCont">Contato a ser alterado</label>
              <select name="tCont" id="cCont"/>

               <?php foreach ($contatos as $cl) {
                 echo "<option>{$cl['id']}</option>";
            ...
            <?php
              //alterar contato
              if(isset($idcontato)){
                $_SESSION['idcont'] = $idcontato;
                echo "<form class='flat' name='formUser' method='post' action='nalt.php'>
                  <div class='row'>
